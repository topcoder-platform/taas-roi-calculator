...
const Footer = () => (
  <footer styleName="footer">
    <p styleName="content-center">
      By clicking “See your results” you agree to our Terms and Privacy Policy. We are never going to sell your data or send you spam. Your information is being used for communication purposes only. Wage and salalry data:
      {' '}
